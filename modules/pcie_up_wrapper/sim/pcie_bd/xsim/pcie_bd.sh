...
#
# Script generated by Vivado on Fri Feb 20 04:35:02 EST 2026
...
#
# Usage        : pcie_bd.sh
#                pcie_bd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pcie_bd.sh [-reset_run]
#                pcie_bd.sh [-reset_log]
#                pcie_bd.sh [-help]
#
...
# script info
echo -e "pcie_bd.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pcie_bd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L gtwizard_ultrascale_v1_7_18 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot pcie_bd xil_defaultlib.pcie_bd xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pcie_bd -key {Behavioral:sim_1:Functional:pcie_bd} -tclbatch cmd.tcl -protoinst "protoinst_files/pcie_bd.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pcie_bd.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pcie_bd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pcie_bd.sh [-help]\n\
Usage: pcie_bd.sh [-step]\n\
Usage: pcie_bd.sh [-lib_map_path]\n\
Usage: pcie_bd.sh [-reset_run]\n\
Usage: pcie_bd.sh [-reset_log]\n\
Usage: pcie_bd.sh [-keep_index]\n\
Usage: pcie_bd.sh [-noclean_files]\n\n\
